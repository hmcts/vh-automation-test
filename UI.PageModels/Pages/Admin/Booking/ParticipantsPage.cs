...
{
    public class ParticipantsPage : VhPage
    {
        ...
        private readonly By _newUserWarning = By.XPath("//*[@id='search-email-component']/app-search-email/div/div[2]/strong");
        ...
        public void AddNewIndividualParticipant(string party, string role, string contactEmail, string displayName, NewParticipantDto newParticipantDto)
        {
        ...
        public void AddNewRepresentative(string party, string role, string contactEmail, string displayName, string representing,  NewParticipantDto newParticipantDto)
        {
	        SelectDropDownByText(_partyDropdown, party);
	        SelectDropDownByText(_roleDropdown, role);
	        EnterText(_participantEmailTextfield, contactEmail);
        ...
        public void AddExistingRepresentative(string party, string role, string contactEmail, string displayName, string representing)
        {
        ...
        {
	        Thread.Sleep(500); // THIS IS ABSOLUTELY REQUIRED - the component takes 500ms to respond to change based on a setTimeout
