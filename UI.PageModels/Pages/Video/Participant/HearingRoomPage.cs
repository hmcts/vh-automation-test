...
public class HearingRoomPage : VhVideoWebPage
{
    ...
    public static By JudgeMicMuted =>
        By.XPath("//div[@id='toggle-audio-mute-img-desktop']//svg[@data-icon='microphone-slash']");

    public static By JudgeMicActive =>
        By.XPath("//div[@id='toggle-audio-mute-img-desktop']//svg[@data-icon='microphone']");
    ...
    public static By ParticipantHandRaised =>
        By.XPath("//div[@colour='grey'][@class='icon-button']//fa-icon[@class='ng-fa-icon yellow']");

    public static By ParticipantCameraOffIcon =>
        By.XPath("//div[@class='icon-button no-click']//fa-icon[@icon='video-slash']");
