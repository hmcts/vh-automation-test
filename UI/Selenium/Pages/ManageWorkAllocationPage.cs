...
namespace UI.Pages
{
    ...
    public class ManageWorkAllocationPage
    {
        ...
        public static By AlloctatedCSOList = By.XPath("//ng-select[@id='user-list']//div[@role='combobox']//following::ng-dropdown-panel//div[@role='option']");
        public static By CaseType = By.Id("caseTypes");
        public static By CaseNumber = By.Id("case-number-entry");
        public static By AllocateHearingSearch = By.CssSelector("(//button[@data-module='govuk-button'][.='Search'])[3]");
